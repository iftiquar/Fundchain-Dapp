import { FundsChartData } from './../fc-chart.service';
...
// interface FundsChartData{
//   labels: string[],
//   Data: number[][]
// }

@Component({
  selector: 'ngx-funds-chart',
  template: `
...
export class FundsChartComponent implements AfterViewInit, OnDestroy, OnChanges  {
  ...
  ngOnChanges(): void {
    if (this.echartsIntance) {
      this.updateProfitChartOptions(this.fundsChartData);
    }
  }
  ...
  setOptions(eTheme) {
    this.options = {
      ...
      xAxis: [
        {
          type: 'category',
          data: this.fundsChartData.labels,
          axisTick: {
            alignWithLabel: true,
          },
          axisLine: {
      ...
      series: [
        {
          ...
          data: this.fundsChartData.Data[0],
        },
        // {
        //   name: 'Payment',
        //   type: 'bar',
        ...
        //     },
        //   },
        //   data: this.fundsChartData.Data[1],
        // },
        // {
        //   name: 'All orders',
        //   type: 'bar',
        ...
        //     },
        //   },
        //   data: this.fundsChartData.Data[2],
        // },
      ],
    };
  }

  updateProfitChartOptions(profitChartData: FundsChartData) {
